...
var CDropdown = (0, import_react48.forwardRef)((_a, ref) => {
  var { children, alignment, as = "div", autoClose = true, className, container, dark, direction, offset: offset2 = [0, 2], onHide, onShow, placement = "bottom-start", popper: popper2 = true, popperConfig, portal = false, reference: reference2 = "toggle", variant = "dropdown", visible = false } = _a, rest = __rest(_a, ["children", "alignment", "as", "autoClose", "className", "container", "dark", "direction", "offset", "onHide", "onShow", "placement", "popper", "popperConfig", "portal", "reference", "variant", "visible"]);
...
var CNavGroup = (0, import_react95.forwardRef)((_a, ref) => {
  ...
  return import_react95.default.createElement(
    ...
    toggler && import_react95.default.createElement("a", { className: "nav-link nav-group-toggle", href: "#", onClick: (event) => handleTogglerOnCLick(event) }, togglerContent),
    import_react95.default.createElement(Transition, { appear: true, in: _visible, nodeRef: navItemsRef, onEntering, onEntered, onExit, onExiting, onExited, timeout: 300 }, (state) => import_react95.default.createElement(NavGroupItemsComponent, { className: classNames("nav-group-items", {
      compact
...
CNavGroup.propTypes = {
  ...
  toggler: import_prop_types86.default.oneOfType([import_prop_types86.default.string, import_prop_types86.default.node, import_prop_types86.default.func]),
...
// node_modules/@coreui/react/dist/esm/components/search-button/CSearchButton.js
var import_react116 = __toESM(require_react());
var import_prop_types106 = __toESM(require_prop_types());

// node_modules/@coreui/react/dist/esm/components/search-button/utils.js
var MODIFIER_KEYS = /* @__PURE__ */ new Set(["alt", "ctrl", "meta", "shift"]);
var KEY_ALIASES = {
  " ": "space",
  cmd: "meta",
  command: "meta",
...
var EDITABLE_TARGET_SELECTOR = 'input, textarea, select, [contenteditable=""], [contenteditable="true"], [contenteditable="plaintext-only"]';
var normalizeKey = (key) => KEY_ALIASES[key.toLowerCase()] || key.toLowerCase();
var parseShortcut = (shortcut) => shortcut.split(",").map((value) => value.trim()).filter(Boolean).map((value) => {
...
var getPlatform = () => {
  ...
  return ((_a = navigator2.userAgentData) === null || _a === void 0 ? void 0 : _a.platform) || navigator2.platform || navigator2.userAgent || "";
};
var isMacOS = () => /Mac|iPhone|iPad|iPod|macOS|Macintosh/.test(getPlatform());
var getPreferredShortcut = (shortcuts) => shortcuts.find((shortcut) => isMacOS() ? shortcut.modifiers.meta : shortcut.modifiers.ctrl) || shortcuts[0] || null;
var getKeyLabel = (key) => KEY_LABELS[key] || (key.length === 1 ? key.toUpperCase() : `${key.charAt(0).toUpperCase()}${key.slice(1)}`);
var formatShortcutTokens = (shortcut) => shortcut.split("+").map((part) => normalizeKey(part.trim())).map((part) => getKeyLabel(part)).filter(Boolean);
var getPressedKeys = (event) => {
...
var shouldIgnoreShortcut = (event) => isEditableTarget(event.target) && !event.ctrlKey && !event.metaKey;
var matchesShortcut = (shortcut, event) => {
...
// node_modules/@coreui/react/dist/esm/components/search-button/CSearchButton.js
var CSearchButton = (0, import_react116.forwardRef)((_a, ref) => {
  ...
  const [activeKeys, setActiveKeys] = (0, import_react116.useState)([]);
  const shortcuts = (0, import_react116.useMemo)(() => parseShortcut(shortcut), [shortcut]);
  const preferredShortcut = (0, import_react116.useMemo)(() => getPreferredShortcut(shortcuts), [shortcuts]);
  const shortcutTokens = (0, import_react116.useMemo)(() => formatShortcutTokens((preferredShortcut === null || preferredShortcut === void 0 ? void 0 : preferredShortcut.shortcut) || ""), [preferredShortcut]);
  const handleShortcut = (0, import_react116.useCallback)((event) => {
    if (disabled || event.defaultPrevented || event.repeat || shouldIgnoreShortcut(event)) {
      return;
    }
    const matchedShortcut = shortcuts.find((shortcut2) => matchesShortcut(shortcut2, event));
    if (!matchedShortcut) {
      return;
    }
    if (preventDefault) {
  ...
  const handleDocumentKeydown = (0, import_react116.useCallback)((event) => {
    setActiveKeys(Array.from(getPressedKeys(event)));
    handleShortcut(event);
  }, [handleShortcut]);
  const handleDocumentKeyup = (0, import_react116.useCallback)((event) => {
    setActiveKeys(Array.from(getPressedKeys(event)));
  }, []);
  const handleWindowBlur = (0, import_react116.useCallback)(() => {
    setActiveKeys([]);
  }, []);
  ...
  return import_react116.default.createElement(
    "button",
    Object.assign({ type, className: classNames("search-button", className), disabled, onClick: handleClick }, rest, { ref: forkedRef }),
    children !== null && children !== void 0 ? children : import_react116.default.createElement(
      import_react116.default.Fragment,
      null,
      icon !== null && icon !== void 0 ? icon : import_react116.default.createElement(
        "svg",
        { className: "search-button-icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", "aria-hidden": "true" },
        import_react116.default.createElement("path", { fill: "currentColor", d: "m479.6 399.716-81.084-81.084-62.368-25.767A175 175 0 0 0 368 192c0-97.047-78.953-176-176-176S16 94.953 16 192s78.953 176 176 176a175.03 175.03 0 0 0 101.619-32.377l25.7 62.2 81.081 81.088a56 56 0 1 0 79.2-79.195M48 192c0-79.4 64.6-144 144-144s144 64.6 144 144-64.6 144-144 144S48 271.4 48 192m408.971 264.284a24.03 24.03 0 0 1-33.942 0l-76.572-76.572-23.894-57.835 57.837 23.894 76.573 76.572a24.03 24.03 0 0 1-.002 33.941" })
      ),
      import_react116.default.createElement("span", { className: "search-button-placeholder" }, placeholder)
    ),
    import_react116.default.createElement("span", { className: "search-button-keys", "aria-hidden": "true" }, shortcutTokens.map((key) => import_react116.default.createElement("span", { className: classNames("search-button-key", { active: activeKeys.includes(key) }), "data-coreui-search-button-key": key, key }, key)))
  );
});
CSearchButton.propTypes = {
  ...
  onTrigger: import_prop_types106.default.func,
  placeholder: import_prop_types106.default.node,
  preventDefault: import_prop_types106.default.bool,
  shortcut: import_prop_types106.default.string
};
...
var CSidebar = (0, import_react117.forwardRef)((_a, ref) => {
  ...
  const sidebarRef = (0, import_react117.useRef)(null);
  const forkedRef = useForkedRef(ref, sidebarRef);
  const [inViewport, setInViewport] = (0, import_react117.useState)();
  const [mobile, setMobile] = (0, import_react117.useState)(false);
  const [visibleMobile, setVisibleMobile] = (0, import_react117.useState)(false);
  const [visibleDesktop, setVisibleDesktop] = (0, import_react117.useState)(visible !== void 0 ? visible : overlaid ? false : true);
  ...
  return import_react117.default.createElement(
    ...
    null,
    import_react117.default.createElement(Component, Object.assign({ className: classNames("sidebar", {
    ...
    typeof window !== "undefined" && mobile && (0, import_react_dom3.createPortal)(import_react117.default.createElement(CBackdrop, { className: "sidebar-backdrop", visible: mobile && visibleMobile }), document.body)
  );
});
CSidebar.propTypes = {
  ...
  colorScheme: import_prop_types107.default.oneOf(["dark", "light"]),
  narrow: import_prop_types107.default.bool,
  onHide: import_prop_types107.default.func,
  onShow: import_prop_types107.default.func,
  onVisibleChange: import_prop_types107.default.func,
  overlaid: import_prop_types107.default.bool,
  placement: import_prop_types107.default.oneOf(["start", "end"]),
  position: import_prop_types107.default.oneOf(["fixed", "sticky"]),
  size: import_prop_types107.default.oneOf(["sm", "lg", "xl"]),
  unfoldable: import_prop_types107.default.bool,
...
var CSidebarBrand = (0, import_react118.forwardRef)((_a, ref) => {
  var { children, as: Component = "a", className } = _a, rest = __rest(_a, ["children", "as", "className"]);
  return import_react118.default.createElement(Component, Object.assign({ className: classNames("sidebar-brand", className), ref }, rest), children);
});
...
var CSidebarFooter = (0, import_react119.forwardRef)((_a, ref) => {
  var { children, className } = _a, rest = __rest(_a, ["children", "className"]);
  return import_react119.default.createElement("div", Object.assign({ className: classNames("sidebar-footer", className), ref }, rest), children);
});
...
var CSidebarToggler = (0, import_react120.forwardRef)((_a, ref) => {
  var { children, className } = _a, rest = __rest(_a, ["children", "className"]);
  return import_react120.default.createElement("button", Object.assign({ className: classNames("sidebar-toggler", className), ref }, rest), children);
});
...
var CSidebarHeader = (0, import_react121.forwardRef)((_a, ref) => {
  var { children, className } = _a, rest = __rest(_a, ["children", "className"]);
  return import_react121.default.createElement("div", Object.assign({ className: classNames("sidebar-header", className), ref }, rest), children);
});
...
var isNavElement = (child) => {
  if (!import_react122.default.isValidElement(child))
    return false;
...
var recursiveClone = (children, id, updateId) => {
  return import_react122.default.Children.map(children, (child, index) => {
    ...
    if (child.props.children) {
      ...
      return import_react122.default.cloneElement(child, {
        idx: _id,
...
var CSidebarNav = (0, import_react122.forwardRef)((_a, ref) => {
  var { children, as: Component = "ul", className, compact, variant } = _a, rest = __rest(_a, ["children", "as", "className", "compact", "variant"]);
  const [visibleGroup, setVisibleGroup] = (0, import_react122.useState)("");
  ...
  return import_react122.default.createElement(
    ...
    import_react122.default.createElement(Component, Object.assign({ className: classNames("sidebar-nav", {
      compact,
      "sidebar-nav-tree": variant === "tree"
    }, className), ref }, rest), recursiveClone(children))
  );
});
CSidebarNav.propTypes = {
  ...
  compact: import_prop_types112.default.bool,
  variant: import_prop_types112.default.oneOf(["tree"])
};
...
var CSpinner = (0, import_react123.forwardRef)((_a, ref) => {
  ...
  return import_react123.default.createElement(
    ...
    import_react123.default.createElement("span", { className: "visually-hidden" }, visuallyHiddenLabel)
  );
});
CSpinner.propTypes = {
  as: import_prop_types113.default.string,
  className: import_prop_types113.default.string,
  color: colorPropType,
  size: import_prop_types113.default.oneOf(["sm"]),
  variant: import_prop_types113.default.oneOf(["border", "grow"]),
  visuallyHiddenLabel: import_prop_types113.default.string
};
...
var CTableHead = (0, import_react124.forwardRef)((_a, ref) => {
  var { children, className, color } = _a, rest = __rest(_a, ["children", "className", "color"]);
  return import_react124.default.createElement("thead", Object.assign({ className: classNames({
    [`table-${color}`]: color
...
var CTableHeaderCell = (0, import_react125.forwardRef)((_a, ref) => {
  var { children, className, color } = _a, rest = __rest(_a, ["children", "className", "color"]);
  return import_react125.default.createElement("th", Object.assign({ className: classNames({
    [`table-${color}`]: color
  }, className) || void 0 }, rest, { ref }), children);
});
...
var CTableBody = (0, import_react126.forwardRef)((_a, ref) => {
  var { children, className, color } = _a, rest = __rest(_a, ["children", "className", "color"]);
  return import_react126.default.createElement("tbody", Object.assign({ className: classNames({
    [`table-${color}`]: color
  }, className) || void 0 }, rest, { ref }), children);
});
...
var CTableDataCell = (0, import_react127.forwardRef)((_a, ref) => {
  ...
  return import_react127.default.createElement(Component, Object.assign({ className: classNames({
    [`align-${align}`]: align,
    "table-active": active,
    [`table-${color}`]: color
  }, className) || void 0 }, rest, { ref }), children);
...
var CTableRow = (0, import_react128.forwardRef)((_a, ref) => {
  var { children, active, align, className, color } = _a, rest = __rest(_a, ["children", "active", "align", "className", "color"]);
  return import_react128.default.createElement("tr", Object.assign({ className: classNames({
    [`align-${align}`]: align,
    "table-active": active,
    [`table-${color}`]: color
  }, className) || void 0 }, rest, { ref }), children);
...
CTableRow.propTypes = {
  ...
  align: import_prop_types118.default.oneOf(["bottom", "middle", "top"]),
...
var CTableFoot = (0, import_react129.forwardRef)((_a, ref) => {
  var { children, className, color } = _a, rest = __rest(_a, ["children", "className", "color"]);
  return import_react129.default.createElement("tfoot", Object.assign({ className: classNames({
    [`table-${color}`]: color
  }, className) || void 0 }, rest, { ref }), children);
});
...
var CTableCaption = (0, import_react130.forwardRef)((_a, ref) => {
  var { children } = _a, props = __rest(_a, ["children"]);
  return import_react130.default.createElement("caption", Object.assign({}, props, { ref }), children);
});
...
var CTableResponsiveWrapper = (_a) => {
  ...
  return responsive ? import_react131.default.createElement("div", Object.assign({ className: typeof responsive === "boolean" ? "table-responsive" : `table-responsive-${responsive}` }, rest), children) : import_react131.default.createElement(import_react131.default.Fragment, null, children);
};
...
// node_modules/@coreui/react/dist/esm/components/table/CTable.js
var CTable = (0, import_react132.forwardRef)((_a, ref) => {
  ...
  const columnNames = (0, import_react132.useMemo)(() => getColumnNames(columns, items), [columns, items]);
  return import_react132.default.createElement(
    ...
    import_react132.default.createElement(
      ...
      (caption && caption !== "top" || captionTop) && import_react132.default.createElement(CTableCaption, null, caption || captionTop),
      columns && import_react132.default.createElement(
        CTableHead,
        Object.assign({}, tableHeadProps),
        import_react132.default.createElement(CTableRow, null, columns.map((column, index) => import_react132.default.createElement(CTableHeaderCell, Object.assign({}, column._props && Object.assign({}, column._props), column._style && { style: Object.assign({}, column._style) }, { key: index }), getColumnLabel(column))))
      ),
      items && import_react132.default.createElement(CTableBody, null, items.map((item, index) => import_react132.default.createElement(CTableRow, Object.assign({}, item._props && Object.assign({}, item._props), { key: index }), columnNames && columnNames.map((colName, index2) => {
        return item[colName] !== void 0 ? import_react132.default.createElement(CTableDataCell, Object.assign({}, item._cellProps && Object.assign(Object.assign({}, item._cellProps["all"] && Object.assign({}, item._cellProps["all"])), item._cellProps[colName] && Object.assign({}, item._cellProps[colName])), { key: index2 }), item[colName]) : null;
      })))),
      children,
      footer && import_react132.default.createElement(
        CTableFoot,
        Object.assign({}, tableFootProps),
        import_react132.default.createElement(CTableRow, null, footer.map((item, index) => import_react132.default.createElement(CTableDataCell, Object.assign({}, typeof item === "object" && item._props && Object.assign({}, item._props), { key: index }), typeof item === "object" ? item.label : item)))
      )
    )
  );
});
CTable.propTypes = {
  align: import_prop_types122.default.oneOf(["bottom", "middle", "top"]),
  borderColor: import_prop_types122.default.string,
  bordered: import_prop_types122.default.bool,
  borderless: import_prop_types122.default.bool,
  caption: import_prop_types122.default.oneOfType([import_prop_types122.default.string, import_prop_types122.default.oneOf(["top"])]),
  captionTop: import_prop_types122.default.string,
  children: import_prop_types122.default.node,
  className: import_prop_types122.default.string,
  color: colorPropType,
  columns: import_prop_types122.default.array,
  footer: import_prop_types122.default.array,
  hover: import_prop_types122.default.bool,
  items: import_prop_types122.default.array,
  responsive: import_prop_types122.default.oneOfType([
    import_prop_types122.default.bool,
    import_prop_types122.default.oneOf(["sm", "md", "lg", "xl", "xxl"])
  ]),
  small: import_prop_types122.default.bool,
  striped: import_prop_types122.default.bool,
  stripedColumns: import_prop_types122.default.bool,
  tableFootProps: import_prop_types122.default.shape(Object.assign({}, CTableFoot.propTypes)),
  tableHeadProps: import_prop_types122.default.shape(Object.assign({}, CTableHead.propTypes))
};
...
var CTabsContext = (0, import_react133.createContext)({});

// node_modules/@coreui/react/dist/esm/components/tabs/CTab.js
var CTab = (0, import_react134.forwardRef)((_a, ref) => {
  var { children, className, itemKey } = _a, rest = __rest(_a, ["children", "className", "itemKey"]);
  const { _activeItemKey, setActiveItemKey, id } = (0, import_react134.useContext)(CTabsContext);
  const isActive = () => itemKey === _activeItemKey;
  return import_react134.default.createElement("button", Object.assign({ className: classNames("nav-link", {
    active: isActive()
...
var CTabContent = (0, import_react135.forwardRef)((_a, ref) => {
  var { children, className } = _a, rest = __rest(_a, ["children", "className"]);
  return import_react135.default.createElement("div", Object.assign({ className: classNames("tab-content", className) }, rest, { ref }), children);
});
...
var CTabPane = (0, import_react136.forwardRef)((_a, ref) => {
  ...
  return import_react136.default.createElement(Transition, { in: visible, nodeRef: tabPaneRef, onEnter: onShow, onExit: onHide, timeout: 150 }, (state) => import_react136.default.createElement("div", Object.assign({ className: classNames("tab-pane", {
    active: visible,
    fade: transition,
    show: state === "entered"
  }, className) }, rest, { ref: forkedRef }), children));
...
var CTabPanel = (0, import_react137.forwardRef)((_a, ref) => {
  ...
  const { _activeItemKey, id } = (0, import_react137.useContext)(CTabsContext);
  const tabPaneRef = (0, import_react137.useRef)(null);
  const forkedRef = useForkedRef(ref, tabPaneRef);
  const [_visible, setVisible] = (0, import_react137.useState)(visible || _activeItemKey === itemKey);
  ...
  return import_react137.default.createElement(Transition, { in: _visible, nodeRef: tabPaneRef, onEnter: onShow, onExit: onHide, timeout: tabPaneRef.current ? getTransitionDurationFromElement(tabPaneRef.current) : 0 }, (state) => import_react137.default.createElement("div", Object.assign({ className: classNames("tab-pane", {
    active: _visible,
    fade: transition,
    show: state === "entered"
...
CTabPanel.propTypes = {
  ...
  itemKey: import_prop_types126.default.oneOfType([import_prop_types126.default.number, import_prop_types126.default.string]).isRequired,
  onHide: import_prop_types126.default.func,
  onShow: import_prop_types126.default.func,
  transition: import_prop_types126.default.bool,
...
var CTabList = (0, import_react138.forwardRef)((_a, ref) => {
  var { children, className, layout, variant } = _a, rest = __rest(_a, ["children", "className", "layout", "variant"]);
  const tabListRef = (0, import_react138.useRef)(null);
  ...
  return import_react138.default.createElement("div", Object.assign({ className: classNames(
    "nav",
    variant === "enclosed-pills" && "nav-enclosed",
    // Enclosed pills variant required for `.nav-enclosed` class
    {
...
CTabList.propTypes = {
  ...
  layout: import_prop_types127.default.oneOf(["fill", "justified"]),
  variant: import_prop_types127.default.oneOf([
    "enclosed",
    "enclosed-pills",
    "pills",
    "tabs",
...
var CTabs = (0, import_react139.forwardRef)(({ children, activeItemKey, className, defaultActiveItemKey, onChange }, ref) => {
  const id = (0, import_react139.useId)();
  const isControlled = activeItemKey !== void 0;
  const [internalActiveItemKey, setInternalActiveItemKey] = (0, import_react139.useState)(() => isControlled ? void 0 : defaultActiveItemKey);
  ...
  return import_react139.default.createElement(
    ...
    import_react139.default.createElement("div", { className: classNames("tabs", className), ref }, children)
  );
});
CTabs.propTypes = {
  activeItemKey: import_prop_types128.default.oneOfType([import_prop_types128.default.number, import_prop_types128.default.string]),
  children: import_prop_types128.default.node,
  className: import_prop_types128.default.string,
  defaultActiveItemKey: import_prop_types128.default.oneOfType([import_prop_types128.default.number, import_prop_types128.default.string]),
...
var CToastContext = (0, import_react140.createContext)({});

// node_modules/@coreui/react/dist/esm/components/toast/CToast.js
var CToast = (0, import_react141.forwardRef)((_a, ref) => {
  ...
  const toastRef = (0, import_react141.useRef)(null);
  const forkedRef = useForkedRef(ref, toastRef);
  const [_visible, setVisible] = (0, import_react141.useState)(false);
  const timeout2 = (0, import_react141.useRef)(void 0);
  ...
  (0, import_react141.useEffect)(() => () => clearTimeout(timeout2.current), []);
  (0, import_react141.useEffect)(() => {
    _autohide();
  }, [_visible]);
  const _autohide = () => {
  ...
  return import_react141.default.createElement(Transition, { in: _visible, nodeRef: toastRef, onEnter: () => onShow && onShow(index !== null && index !== void 0 ? index : null), onExited: () => onClose && onClose(index !== null && index !== void 0 ? index : null), timeout: 250, unmountOnExit: true }, (state) => import_react141.default.createElement(
    CToastContext.Provider,
    { value: contextValues },
    import_react141.default.createElement("div", Object.assign({ className: classNames("toast", {
      fade: animation,
      [`bg-${color}`]: color,
      "border-0": color,
...
CToast.propTypes = {
  animation: import_prop_types129.default.bool,
  autohide: import_prop_types129.default.bool,
  ...
  innerKey: import_prop_types129.default.oneOfType([import_prop_types129.default.number, import_prop_types129.default.string]),
  onClose: import_prop_types129.default.func,
  onShow: import_prop_types129.default.func,
  visible: import_prop_types129.default.bool
};
...
var CToastBody = (0, import_react142.forwardRef)((_a, ref) => {
  var { children, className } = _a, rest = __rest(_a, ["children", "className"]);
  return import_react142.default.createElement("div", Object.assign({ className: classNames("toast-body", className) }, rest, { ref }), children);
});
...
var CToastClose = (0, import_react143.forwardRef)((_a, ref) => {
  var { children, as: Component } = _a, rest = __rest(_a, ["children", "as"]);
  const { setVisible } = (0, import_react143.useContext)(CToastContext);
  return Component ? import_react143.default.createElement(Component, Object.assign({ onClick: () => setVisible(false) }, rest, { ref }), children) : import_react143.default.createElement(CCloseButton, Object.assign({ onClick: () => setVisible(false) }, rest, { ref }));
});
CToastClose.propTypes = Object.assign(Object.assign({}, CCloseButton.propTypes), { as: import_prop_types131.default.elementType });
...
var CToastHeader = (0, import_react144.forwardRef)((_a, ref) => {
  ...
  return import_react144.default.createElement(
    ...
    children,
    closeButton && import_react144.default.createElement(CToastClose, null)
  );
});
CToastHeader.propTypes = {
  children: import_prop_types132.default.node,
  className: import_prop_types132.default.string,
  closeButton: import_prop_types132.default.bool
};
...
var CToaster = (0, import_react145.forwardRef)((_a, ref) => {
  var { children, className, placement, push } = _a, rest = __rest(_a, ["children", "className", "placement", "push"]);
  const [toasts, setToasts] = (0, import_react145.useState)([]);
  const index = (0, import_react145.useRef)(0);
  ...
  const addToast = (push2) => {
    setToasts((state) => [
      ...state,
      import_react145.default.cloneElement(push2, {
        index: index.current,
  ...
  return import_react145.default.createElement(CConditionalPortal, { portal: typeof placement === "string" }, toasts.length > 0 || children ? import_react145.default.createElement(
    "div",
    ...
    children,
    toasts.map((toast, index2) => import_react145.default.cloneElement(toast, { visible: true, key: index2 }))
  ) : null);
});
CToaster.propTypes = {
  children: import_prop_types133.default.node,
  className: import_prop_types133.default.string,
  placement: import_prop_types133.default.oneOfType([
    import_prop_types133.default.string,
    import_prop_types133.default.oneOf([
      "top-start",
      "top-center",
      "top-end",
      "middle-start",
  ...
  push: import_prop_types133.default.any
};
...
var CTooltip = (0, import_react146.forwardRef)((_a, ref) => {
  ...
  const tooltipRef = (0, import_react146.useRef)(null);
  const togglerRef = (0, import_react146.useRef)(null);
  const forkedRef = useForkedRef(ref, tooltipRef);
  const id = `tooltip${(0, import_react146.useId)()}`;
  const [mounted, setMounted] = (0, import_react146.useState)(false);
  const [_visible, setVisible] = (0, import_react146.useState)(visible);
  ...
  return import_react146.default.createElement(
    ...
    null,
    import_react146.default.cloneElement(children, Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, _visible && {
      "aria-describedby": id
    }), { ref: togglerRef }), (trigger === "click" || trigger.includes("click")) && {
      onClick: () => _visible ? handleHide() : handleShow()
    }), (trigger === "focus" || trigger.includes("focus")) && {
    ...
    import_react146.default.createElement(CConditionalPortal, { container, portal: true }, mounted && import_react146.default.createElement(
      "div",
      Object.assign({ className: classNames("tooltip", "bs-tooltip-auto", {
        fade: animation,
        show: _visible
      }, className), id, ref: forkedRef, role: "tooltip" }, rest),
      import_react146.default.createElement("div", { className: "tooltip-arrow" }),
      import_react146.default.createElement("div", { className: "tooltip-inner" }, content)
    ))
  );
});
CTooltip.propTypes = {
  animation: import_prop_types134.default.bool,
  children: import_prop_types134.default.node,
  container: import_prop_types134.default.any,
  content: import_prop_types134.default.oneOfType([import_prop_types134.default.string, import_prop_types134.default.node]),
  delay: import_prop_types134.default.oneOfType([
    import_prop_types134.default.number,
    import_prop_types134.default.shape({
      show: import_prop_types134.default.number.isRequired,
      hide: import_prop_types134.default.number.isRequired
    })
  ]),
  fallbackPlacements: fallbackPlacementsPropType,
  offset: import_prop_types134.default.any,
  // TODO: find good proptype
  onHide: import_prop_types134.default.func,
  onShow: import_prop_types134.default.func,
  placement: import_prop_types134.default.oneOf(["auto", "top", "right", "bottom", "left"]),
  popperConfig: import_prop_types134.default.oneOfType([import_prop_types134.default.func, import_prop_types134.default.object]),
  trigger: triggerPropType,
  visible: import_prop_types134.default.bool
};
...
var CWidgetStatsA = (0, import_react147.forwardRef)((_a, ref) => {
...
var CWidgetStatsB = (0, import_react148.forwardRef)((_a, ref) => {
  ...
  return import_react148.default.createElement(
    ...
    import_react148.default.createElement(
      ...
      title && import_react148.default.createElement("div", null, title),
      import_react148.default.createElement(CProgress, Object.assign({ className: "my-2", height: 4 }, inverse && { white: true }, progress)),
      text && import_react148.default.createElement("small", { className: inverse ? "text-white text-opacity-75" : "text-body-secondary" }, text)
    )
  );
});
CWidgetStatsB.propTypes = {
  ...
  text: import_prop_types136.default.string,
...
var CWidgetStatsC = (0, import_react149.forwardRef)((_a, ref) => {
  ...
  return import_react149.default.createElement(
    ...
    import_react149.default.createElement(
      CCardBody,
      null,
      icon && import_react149.default.createElement("div", { className: classNames("text-end mb-4", inverse ? "text-white text-opacity-75" : "text-body-secondary") }, icon),
      value && import_react149.default.createElement("div", { className: "fs-4 fw-semibold" }, value),
      title && import_react149.default.createElement("div", { className: inverse ? "text-white text-opacity-75" : "text-body-secondary" }, title),
      import_react149.default.createElement(CProgress, Object.assign({ className: "mt-3 mb-0", height: 4 }, inverse && { white: true }, progress))
    )
  );
});
CWidgetStatsC.propTypes = {
  ...
  inverse: import_prop_types137.default.bool,
  progress: import_prop_types137.default.object,
...
var CWidgetStatsD = (0, import_react150.forwardRef)((_a, ref) => {
  ...
  return import_react150.default.createElement(
    ...
    import_react150.default.createElement(CCardBody, { className: "row text-center" }, values && values.map((value, index) => {
      return import_react150.default.createElement(
        import_react150.default.Fragment,
        { key: index },
        index % 2 !== 0 && import_react150.default.createElement("div", { className: "vr" }),
        import_react150.default.createElement(
          CCol,
          null,
          import_react150.default.createElement("div", { className: "fs-5 fw-semibold" }, value.value),
          import_react150.default.createElement("div", { className: "text-uppercase text-body-secondary small" }, value.title)
        )
      );
    }))
  );
...
CWidgetStatsD.propTypes = {
  ...
  color: colorPropType,
  icon: import_prop_types138.default.oneOfType([import_prop_types138.default.string, import_prop_types138.default.node]),
  values: import_prop_types138.default.arrayOf(import_prop_types138.default.any)
};
...
var CWidgetStatsE = (0, import_react151.forwardRef)((_a, ref) => {
  ...
  return import_react151.default.createElement(
    ...
    import_react151.default.createElement(
      ...
      title && import_react151.default.createElement("div", { className: "text-body-secondary small text-uppercase fw-semibold" }, title),
      value && import_react151.default.createElement("div", { className: "fs-6 fw-semibold py-3" }, value),
      chart
    )
  );
});
CWidgetStatsE.propTypes = {
  ...
  chart: import_prop_types139.default.oneOfType([import_prop_types139.default.string, import_prop_types139.default.node]),
...
var CWidgetStatsF = (0, import_react152.forwardRef)((_a, ref) => {
  ...
  return import_react152.default.createElement(
    ...
    import_react152.default.createElement(
      ...
      import_react152.default.createElement("div", { className: `me-3 text-white bg-${color} ${padding ? "p-3" : "p-4"}` }, icon),
      import_react152.default.createElement(
        "div",
        null,
        import_react152.default.createElement("div", { className: `fs-6 fw-semibold text-${color}` }, value),
        import_react152.default.createElement("div", { className: "text-body-secondary text-uppercase fw-semibold small" }, title)
      )
    ),
    footer && import_react152.default.createElement(CCardFooter, null, footer)
  );
});
CWidgetStatsF.propTypes = {
  className: import_prop_types140.default.string,
  color: colorPropType,
  footer: import_prop_types140.default.oneOfType([import_prop_types140.default.string, import_prop_types140.default.node]),
  icon: import_prop_types140.default.oneOfType([import_prop_types140.default.string, import_prop_types140.default.node]),
  padding: import_prop_types140.default.bool,
  title: import_prop_types140.default.oneOfType([import_prop_types140.default.string, import_prop_types140.default.node]),
  value: import_prop_types140.default.oneOfType([import_prop_types140.default.string, import_prop_types140.default.node, import_prop_types140.default.number])
};
...
var useClipboard = () => {
  const [isCopied, setIsCopied] = (0, import_react153.useState)(false);
  const [error, setError] = (0, import_react153.useState)(null);
  const copy = (0, import_react153.useCallback)((text) => __awaiter(void 0, void 0, void 0, function* () {
...
var useColorModes = (localStorageItemName = "coreui-react-color-scheme") => {
  const [colorMode, setColorMode] = (0, import_react154.useState)(getPreferredColorScheme(localStorageItemName));
