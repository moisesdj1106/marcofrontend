...
const CNavGroup = React.forwardRef((_a, ref) => {
    ...
    return (React.createElement(Component, Object.assign({ className: index.default('nav-group', { show: _visible }, className) }, rest, { ref: ref }),
        ...
        React.createElement(Transition.default, { appear: true, in: _visible, nodeRef: navItemsRef, onEntering: onEntering, onEntered: onEntered, onExit: onExit, onExiting: onExiting, onExited: onExited, timeout: 300 }, (state) => (React.createElement(NavGroupItemsComponent, { className: index.default('nav-group-items', {
                compact: compact,
